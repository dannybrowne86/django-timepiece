...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('timepiece_business', 'short_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=4))

    def backwards(self, orm):

        # Changing field 'Business.short_name'
        db.alter_column('timepiece_business', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=3, unique=True))
    ...
    models = {
        ...
        u'crm.business': {
            ...
            'short_name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '4', 'blank': 'True'}),
